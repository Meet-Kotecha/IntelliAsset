...
export function generateSeedData() {
  ...
  const users = [
    { id: uuid(), email: 'admin@intelliasset.io', password: 'admin123', name: 'Alex Chen', role: 'Admin', departmentId: departments[0].id, avatar: '🧑‍💼', status: 'Active' },
    { id: uuid(), email: 'manager@intelliasset.io', password: 'manager123', name: 'Priya Sharma', role: 'Asset Manager', departmentId: departments[2].id, avatar: '👩‍💼', status: 'Active' },
    { id: uuid(), email: 'lead@intelliasset.io', password: 'lead123', name: 'Marcus Johnson', role: 'Department Head', departmentId: departments[0].id, avatar: '👨‍💻', status: 'Active' },
    { id: uuid(), email: 'sarah@intelliasset.io', password: 'emp123', name: 'Sarah Williams', role: 'Employee', departmentId: departments[1].id, avatar: '👩‍🎨', status: 'Active' },
    { id: uuid(), email: 'david@intelliasset.io', password: 'emp123', name: 'David Kim', role: 'Employee', departmentId: departments[0].id, avatar: '🧑‍💻', status: 'Active' },
    { id: uuid(), email: 'lisa@intelliasset.io', password: 'emp123', name: 'Lisa Rodriguez', role: 'Employee', departmentId: departments[3].id, avatar: '👩‍💼', status: 'Active' },
    { id: uuid(), email: 'james@intelliasset.io', password: 'emp123', name: 'James Wilson', role: 'Employee', departmentId: departments[4].id, avatar: '🧔', status: 'Active' },
  ];
