...
export const ROLE_ROUTES = {
  [ROLES.ADMIN]: ['/admin', '/departments', '/categories', '/people', '/assets', '/allocations', '/bookings', '/maintenance', '/audits', '/reports', '/activity', '/settings'],
  [ROLES.ASSET_MANAGER]: ['/manager', '/assets', '/allocations', '/bookings', '/maintenance', '/reports'],
  [ROLES.DEPARTMENT_HEAD]: ['/department', '/department-assets', '/department-employees', '/bookings', '/transfers'],
  [ROLES.EMPLOYEE]: ['/employee', '/my-assets', '/bookings', '/my-requests']
};
